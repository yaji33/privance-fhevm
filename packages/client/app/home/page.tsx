...
export default function HomePage() {
  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      {/* ===== DEVELOPER INFO ===== */}
      <section className="bg-black text-white py-28 px-6 sm:px-8">
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-slate-800/40 to-slate-900/40 border border-slate-700/50 p-8 sm:p-12 text-center backdrop-blur-sm">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8">Built on Zama&apos;s FHEVM</h2>
          <p className="text-slate-300 text-base sm:text-lg mb-12 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="bg-black/30 border border-green-900/30 p-8">
              <h3 className="text-xl font-semibold mb-3 text-green-400">Sepolia Testnet</h3>
            ...
            <div className="bg-black/30 border border-green-900/30 p-8">
              <h3 className="text-xl font-semibold mb-3 text-green-400">Zama FHEVM</h3>
              <p className="text-slate-400 text-sm sm:text-base leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center items-center sm:w-full sm:px-0">
            <a
              href="https://github.com/zama-ai/fhevm"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-8 py-3.5 bg-[#98E29D] text-gray-900 font-semibold hover:bg-green-300 transition shadow-lg"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-8 py-3.5 border-2 border-green-100 text-white font-semibold hover:bg-green-400/10 transition"
            >
              Join Zama Builders
            </a>
          </div>
